...
public class GlobalErrorHandlerControllerTest
{
    ...
    @Test
    public void should_be_able_to_handle_405_error() throws Exception
    {
        // then
        this.mockMvc.perform(post("/api/error/405"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status", is("405")));
    }

    @Test
    public void should_be_able_to_handle_415_error() throws Exception
    {
        // then
        this.mockMvc.perform(post("/api/error/415"))
                .andExpect(status().isOk())
